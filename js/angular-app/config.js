...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('anasayfa', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/anasayfa_controller.js', 'js/angular-services/kullanici.js']
                        },
                        ...
                        {
                            files: ['js/angular-services/profil_bilgileri.js', 'js/angular-services/kullanici.js']
                        }
                    ]);
                }
            }
        ...
        .state('proje.projekurumlistesi', {
            url: "/projekurumlistesi/:projeKurumID",
            controller: 'proje_kurum_liste_controller',
            templateUrl: "views/proje_kurum_liste.html",
            data: { pageTitle: 'Proje Kurum Listesi' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_kurum_liste_controller.js', 'js/angular-services/proje_kurum.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('proje.projekurumkayit', {
            url: "/projekurumkayit/:projeKurumID",
            controller: 'proje_kurum_kayit_controller',
            templateUrl: "views/proje_kurum_kayit.html",
            data: { pageTitle: 'Proje Kurum Kayıt' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_kurum_kayit_controller.js', 'js/angular-services/proje_kurum.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('proje.projekurumbirimlistesi', {
            url: "/projekurumbirimlistesi/:projeKurumID",
            controller: 'proje_kurum_birim_liste_controller',
            templateUrl: "views/proje_kurum_birim_liste.html",
            data: { pageTitle: 'Proje Kurum Birim Listesi' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_kurum_birim_liste_controller.js', 'js/angular-services/proje_kurum_birim.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('proje.projekurumbirimkayit', {
            url: "/projekurumbirimkayit/:projeKurumID/:projeKurumBirimID",
            controller: 'proje_kurum_birim_kayit_controller',
            templateUrl: "views/proje_kurum_birim_kayit.html",
            data: { pageTitle: 'Proje Kurum Birim Kayıt' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_kurum_birim_kayit_controller.js', 'js/angular-services/proje_kurum_birim.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            files: ['js/angular-services/proje_personel_rol.js']
                        },
                        {
                            files: ['js/angular-services/personel_tipi.js']
                        },
        ...
        .state('proje.projelerkayit.plan.projeplanilistesi', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_plani_liste_controller.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('proje.projelerkayit.plan.projeplanikayit', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_plani_kayit_controller.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('proje.projelerkayit.lisans', {
            url: "/lisans",
            templateUrl: "views/proje_lisans.html",
            data: { pageTitle: 'Proje Lisans' },

        })

        .state('proje.projelerkayit.lisans.projelisanslistesi', {
            url: "/projelisanslistesi",
            controller: 'proje_lisans_liste_controller',
            templateUrl: "views/proje_lisans_liste.html",
            data: { pageTitle: 'Proje Lisans Listesi', altTab: 7 },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_lisans_liste_controller.js', 'js/angular-services/proje_lisans.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
                        ...
                        {
                            files: ['js/angular-services/proje_kurum.js']
                        },
                        {
                            files: ['js/angular-controller/proje_kurum_birim_liste_controller.js', 'js/angular-services/proje_kurum_birim.js']
                        },
        ...
        .state('proje.projelerkayit.lisans.projelisanskayit', {
            url: "/projelisanskayit/:projeLisansID",
            controller: 'proje_lisans_kayit_controller',
            templateUrl: "views/proje_lisans_kayit.html",
            data: { pageTitle: 'Proje Lisans Kayıt' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/proje_lisans_kayit_controller.js', 'js/angular-services/proje_lisans.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
                        ...
                        {
                            files: ['js/angular-services/proje_kurum_birim.js']
                        },
                        {
                            files: ['js/angular-services/projeler.js']
                        },
        ...
        .state('insankaynaklari.ikpersonelkayit.ikpersonelizinlistesi', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/ik_personel_izin_liste_controller.js', 'js/angular-services/ik_personel_izin.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('insankaynaklari.ikzimmetlistesi', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/ik_zimmet_liste_controller.js', 'js/angular-services/ik_zimmet.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('toplanti.toplantilistesi', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/toplanti_liste_controller.js', 'js/angular-services/toplanti.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('toplanti.toplantikatilimcirolutipilistesi', {
            url: "/toplantikatilimcirolutipilistesi",
            controller: 'toplanti_katilimci_rolu_tipi_liste_controller',
            templateUrl: "views/toplanti_katilimci_rolu_tipi_liste.html",
            data: { pageTitle: 'Toplantı Katılımcı Rolu Tipi Listesi' },
        ...
        .state('toplanti.toplantikatilimcirolutipikayit', {
            url: "/toplantikatilimcirolutipikayit/:ToplantiKatilimciRoluTipiID",
            controller: 'toplanti_katilimci_rolu_tipi_kayit_controller',
            templateUrl: "views/toplanti_katilimci_rolu_tipi_kayit.html",
            data: { pageTitle: 'Toplantı Katılımcı Rolu Tipi Kayıt' },
        ...
        .state('talep.talepprojelistesi', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/talep_proje_liste_controller.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            files: ['js/angular-controller/talep_proje_kayit_controller.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        .state('danismanlik.firmalistesi', {
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            files: ['js/angular-controller/d_firma_liste_controller.js', 'js/angular-services/d_firma.js']
                        },
                        {
                            files: ['css/plugins/iCheck/custom.css', 'js/plugins/iCheck/icheck.min.js']
                        },
        ...
        //.state('danismanlik.firmakayit.danismanplan', {
        //    url: "/danismanplan",
        //    templateUrl: "views/d_danismanlik_hizmet_danisman_plan.html",
        //    data: { pageTitle: 'Danışmanlık Hizmet Danışman Planı', altTab: 4 },
