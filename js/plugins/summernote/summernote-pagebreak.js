...
(function($) {
  ...
  $.extend($.summernote.options, {
    pagebreak: {
      ...
      css: '@media all{.note-editable .page-break{position:relative;display:block;width:100%;height:1px;background-color:#ddd;margin:15px 0;}.note-editable .page-break:after{content:"Sayfa-Sonu";position:absolute;width:100%;height:20px;top:-10px;color:#ddd;-webkit-text-shadow:0 0 5px #fff,0 0 5px #fff,0 0 5px #fff,0 0 5px #fff;-moz-text-shadow:0 0 5px #fff,0 0 5px #fff,0 0 5px #fff,0 0 5px #fff;text-shadow:0 0 5px #fff,0 0 5px #fff,0 0 5px #fff,0 0 5px #fff;text-align:center;}}@media print{.note-editable .page-break{display:block;page-break-before:always;}}'
    }
  });
            ...
            if (getSelection().rangeCount > 0) {
              ...
              if (!$(el).hasClass('page-break')) {
                if ($(el).next('div.page-break').length < 1)
                  $('<div class="page-break"></div>').insertBefore(el);
              }
            } else {
