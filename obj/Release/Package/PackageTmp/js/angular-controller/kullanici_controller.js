angular.module('inspinia').controller(
    'kullanici_controller', ['$scope', '$http', '$state', '$stateParams', '$document', '$window', '$log', '$localStorage', '$sessionStorage', '$rootScope', '$modal', 'ngDialog', 'srvKullanici', 'srvGenel', 'Constants', 'srvRaporlar', 'Ayarlarim',
        function ($scope, $http, $state, $stateParams, $document, $window, $log, $localStorage, $sessionStorage, $rootScope, $modal, ngDialog, srvKullanici, srvGenel, Constants, srvRaporlar, Ayarlarim) {
