...
nyaBsSelect.directive('nyaBsSelect', ['$parse', '$document', '$timeout', '$compile', 'nyaBsConfig', function ($parse, $document, $timeout, $compile, nyaBsConfig) {
  ...
  var DROPDOWN_CLEAR = '<a role="button" class="clear">&times;</a>';
  ...
  return {
    ...
    compile: function nyaBsSelectCompile (tElement, tAttrs){
      ...
      var options = tElement.children(),
        ...
        dropdownClear = jqLite(DROPDOWN_CLEAR),
      ...
      classList.forEach(function(className) {
        ...
        if(/btn-(?:lg|sm|xs)/.test(className)) {
          tElement.removeClass(className);
          dropdownClear.addClass(className);
          dropdownToggle.addClass(className);
        }
      ...
      if(typeof tAttrs.allowClear !== 'undefined') {
        tElement.append(dropdownClear);
      }
      ...
      return function nyaBsSelectLink ($scope, $element, $attrs, ctrls) {
        ...
        var dropdownToggle = jqLite($element[0].querySelector('.dropdown-toggle')),
          ...
          dropdownClear = jqLite($element[0].querySelector('.clear')),
        ...
        // clear button
        if ($attrs.allowClear === 'true') {
            dropdownClear.on('click', function() {
                if(ngCtrl.$viewValue == null) return;
                ngCtrl.$setViewValue(null);
                ngCtrl.$render();
                updateButtonContent();
            });
        }
        ...
        $element.on('keydown', function(event){
          ...
          if(keyCode !== 27 && keyCode !== 13 && keyCode !== 38 && keyCode !== 40 && keyCode !== 46) {
        ...
        function updateButtonContent() {
          ...
          var dropdownClear = jqLite($element[0].querySelector('.clear'));
          ...
          if(typeof viewValue === 'undefined' || viewValue === null) {
            ...
            dropdownClear.addClass('hide');
            filterOption.empty();
            return;
          }
          dropdownClear.removeClass('hide');
